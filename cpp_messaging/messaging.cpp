...
void ServerResponse::setIntParameter(std::string param, int intValue) {
  setMember(paramsMember(), param, std::move(rapidjson::Value{intValue}),
            document.GetAllocator());
}

const rapidjson::Value &
ClientRequest::getParameter(const std::string_view name) const noexcept {
